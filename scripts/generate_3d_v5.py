...
scene.add(sticksGroup, swagesGroup, lipMarkersGroup, legMarkersGroup, labelsGroup);
...
const otherTools = Object.keys(tc).filter(k => !['SWAGE','LIP NOTCH','LEFT LEG NOTCH','RIGHT LEG NOTCH','BOLT HOLES'].includes(k));
